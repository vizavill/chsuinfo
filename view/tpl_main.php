...
<body>
	<div id="header">
		<div id="header_content">
			...
			<?else:?>
				<a href="#" class="vk-link" style="margin-left: 15px;">Войти через<img src="/view/red2014/images/vk.png" width="20px;" style="padding-left:3px;"></a>
			<?endif?>			
			<span>
				<a href="index.php" id="active">Расписание</a> / <a href="http://m.chsuinfo.ru/">Mobile</a> / <a href="index.php?c=sms_vk_rasp">SMS & VK</a> / <a href="#">Блог</a> / <a href="#">Мероприятия</a>
			</span>
	...
	<div id="footer">
		<div id="footer-content">
			<span class="link">© 2014 ChsuInfo.ru</span> Расписание обновляется ежедневно. <span class="authors" style="float:right;">Есть вопросы или нашли ошибку? <a href="#" target="_blank">Алексей Дурягин</a> / <a href="#" target="_blank">Вадим Осюков</a></span>
		</div>
	</div>
