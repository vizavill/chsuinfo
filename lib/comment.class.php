		...
		return '
				<div class="commVk">
					...
					<div class="commentPanel">
						'.$delOrtw.'
						<a href="http://vk.com/share.php?title=Комментарии на chsuinfo.ru&url=http://chsuinfo.ru&description='.$vkText.'" target="_blank" class="panLink" title="Запостить в вконтакте"><img src="/view'.THEME.'/images/vk_c.png"></a><br>
						'.$extLinks.'
					</div>
				</div>
		';
