...
class Parsesr_html
{
	...
	public function parser_rasp($html,$table,$grup, $semestr)	
		...
		do
		{
			...
			$query="INSERT INTO $table (semestr,grup,day,time,discip,n_week,k_week,parity,lecturer,address) VALUES ('$semestr','$grup','$str_day','$str_time','$str_discip','$n_week','$k_week','$str_parity','$str_lecturer','$str_address')";
			mysql_query($query) or die( mysql_error());
			}
			}
